...
digit_t *gp_selected_digit = ((void*)0);

__attribute__((inline)) void init_digit(void);
void select_digit(void);
__attribute__((inline)) void end_select_digit(void);
__attribute__((inline)) void increase_digit(void);
__attribute__((inline)) void decrease_digit(void);
__attribute__((inline)) void display_refresh(void);
__attribute__((inline)) void blink_digit(void);
__attribute__((inline)) uint16_t get_display_value(void);
...
__attribute__((inline)) void handle_received_commands(void);
__attribute__((inline)) void decrease_num(void);
__attribute__((inline)) void increase_num_automatic(void);
__attribute__((inline)) void set_display_value_manual(void);
...
uint8_t g_7seg_table[10] = {0x3F, 0x06, 0x5B, 0x4F,
    0x66, 0x6D, 0x7D, 0x07,
    0x7F, 0x6F};
uint8_t middle_line_7seg = 0x40;

uint16_t g_decrease_delay = 10;
uint16_t g_increase_delay = 10;
...
void main(void) {
    ...
    TMR2_SetInterruptHandler(display_refresh);
    TMR4_SetInterruptHandler(decrease_num);
    TMR6_SetInterruptHandler(increase_num_automatic);
...
__attribute__((inline)) void handle_received_commands(void) {
    ...
    if (EUSART_is_rx_ready()) {
        ...
        switch (rxData) {
            ...
            case RX_SELECT_DIGIT:

                select_digit();
                break;

            case RX_END_SELECT_DIGIT:

                end_select_digit();
                break;

            case RX_INCREASE_DIGIT:
            ...
            case RX_7SEG_SET_ZERO:

                set_display_value(0);
                break;

            case RX_7SEG_STORE_MASS:

                g_mass = get_display_value();
                break;


            case RX_7SEG_SHOW_MASS:

                set_display_value(g_mass);
                break;


            case RX_7SEG_STORE_TIME:
            ...
            case RX_7SEG_SHOW_TIME:

                set_display_value(g_time_ms);
                break;


            case RX_7SEG_STORE_INITIAL_VALUE:

                g_setted_value = get_display_value();
                break;


            case RX_START_DECREASE:

                g_decrease_delay = g_time_ms / 10;
                TMR4_StartTimer();
                break;


            case RX_STOP_DECREASE:

                TMR4_StopTimer();
                break;


            case RX_START_INCREASE:

                set_display_value(0);
                g_increase_delay = g_time_ms / 10;
                TMR6_StartTimer();
                break;


            case RX_STOP_INCREASE_SET_MANUAL:
...
__attribute__((inline)) void decrease_num(void) {
    ...
    if (g_decrease_delay == tmr4_counter) {
        ...
        if ((0x3F == g_sadegan.seven_segment_maping) &&
                ...
                (0x3F == g_yekan.seven_segment_maping)) {
...
__attribute__((inline)) void increase_num_automatic(void) {
    ...
    if (g_increase_delay == tmr6_counter) {
        ...
        if ((0x6F == g_sadegan.seven_segment_maping) &&
                ...
                (0x6F == g_yekan.seven_segment_maping)) {
...
__attribute__((inline)) void increase_num_manual(void) {
