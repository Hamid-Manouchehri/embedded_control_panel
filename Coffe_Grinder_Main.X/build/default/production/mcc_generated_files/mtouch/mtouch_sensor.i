...
static mtouch_sensor_t mtouch_sensor[9u] ={
    {T_1,MTOUCH_CVD_ScanA_0,MTOUCH_CVD_ScanB_0, 32u,0,0,0,0},
    {T_2,MTOUCH_CVD_ScanA_1,MTOUCH_CVD_ScanB_1, 32u,0,0,0,0},
    {T_3,MTOUCH_CVD_ScanA_2,MTOUCH_CVD_ScanB_2, 32u,0,0,0,0},
    {T_4,MTOUCH_CVD_ScanA_3,MTOUCH_CVD_ScanB_3, 32u,0,0,0,0},
    {T_8,MTOUCH_CVD_ScanA_4,MTOUCH_CVD_ScanB_4, 32u,0,0,0,0},
    {T_7,MTOUCH_CVD_ScanA_5,MTOUCH_CVD_ScanB_5, 32u,0,0,0,0},
    {T_6,MTOUCH_CVD_ScanA_6,MTOUCH_CVD_ScanB_6, 32u,0,0,0,0},
    {T_5,MTOUCH_CVD_ScanA_7,MTOUCH_CVD_ScanB_7, 32u,0,0,0,0},
    {T_9,MTOUCH_CVD_ScanA_8,MTOUCH_CVD_ScanB_8, 32u,0,0,0,0},
};
...
# 194 "mcc_generated_files/mtouch/mtouch_sensor.c"
_Bool MTOUCH_Sensor_SampleAll(void)
{
    enum mtouch_sensor_names sensor;
    for (sensor = 0; sensor < 9u; sensor++)
...
# 222 "mcc_generated_files/mtouch/mtouch_sensor.c"
_Bool MTOUCH_Sensor_isAnySensorActive(void)
{
    enum mtouch_sensor_names sensor;
...
# 386 "mcc_generated_files/mtouch/mtouch_sensor.c"
static void Sensor_Acq_ExecuteScan(void)
{
...
# 482 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Disable(enum mtouch_sensor_names sensor)
{
    if(sensor < 9u)
...
# 517 "mcc_generated_files/mtouch/mtouch_sensor.c"
static __attribute__((inline)) void Sensor_setActive(mtouch_sensor_t* sensor)
{
    sensor->active = 1;
}
...
# 554 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Sampled_ResetAll(void)
{
    mtouch_sensor_t* sensor;
    for(sensor = &mtouch_sensor[0];sensor<= &mtouch_sensor[9u -1];sensor++)
    {
